//! Electrical admittance (base unit siemens, m⁻² · kg⁻¹ · s³ · A²).
//! 
//! This is typically a complex number, with the real part being the [conductance](crate::si::electrical_conductance), and the complex part being the [susceptance](crate::si::electrical_susceptance).

quantity! {
    /// Electrical admittance (base unit siemens, m⁻² · kg⁻¹ · s³ · A²).
    quantity: ElectricalAdmittance; "electrical admittance";
    /// Dimension of electrical admittance, L⁻²M⁻¹T³I² (base unit siemens, m⁻² · kg⁻¹ · s³ · A²).
    dimension: ISQ<
        N2,     // length
        N1,     // mass
        P3,     // time
    ...
    kind: dyn (crate::si::marker::ElectricalAdmittanceKind);
    units {
        ...
        /// Derived unit of electrical admittance.
